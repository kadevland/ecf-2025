...
final class Footer extends Component
{
    ...
    {
        $this->footerLinks = array_merge(
            $this->footerLinks,
            $this->getMainFooterLinks(),
        );

        $this->legalLinks = array_merge(
            $this->legalLinks,
            $this->getLegalFooterLinks()
        );

        $this->socialLinks = array_merge(
            $this->socialLinks,
    ...
    /**
     * Summary of getMainFooterLinks
     *
     * @return array<array{href: string, label: string}>
     */
    private function getMainFooterLinks(): array
    {
        return [
            ['href' => '#', 'label' => 'À propos'],
            ['href' => '#', 'label' => 'Contact'],
    ...
    /**
     * Summary of getLegalFooterLinks
     *
     * @return array<array{href: string, label: string}>
     */
    private function getLegalFooterLinks(): array
    {
        return [
    ...
    /**
     * Summary of getSocialMediaLinks
     *
    ...
    private function getCompanyInfos(): void
    {
        $this->companyName        = 'Cinéphoria - Réseau de 7 cinémas';
        $this->companyDescription = 'France & Belgique | 20% du CA reversé pour l\'écologie';
        $this->copyright          = 'Copyright © 2025 - Tous droits réservés';
    }
}
