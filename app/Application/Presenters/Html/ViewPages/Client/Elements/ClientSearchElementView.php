...
namespace App\Application\Presenters\Html\ViewPages\Client\Elements;

/**
 * Élément de recherche pour les clients
 */
final readonly class ClientSearchElementView
{
    ...
    {
        return route('gestion.supervision.clients.index');
    }
