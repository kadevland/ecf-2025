...
/**
 * @implements ApplicatorInterface<\Illuminate\Database\Eloquent\Model, ConditionGreaterThanOrEqual>
 */
final class GreaterThanOrEqualApplicator implements ApplicatorInterface
{
     ...
     * @param  ConditionGreaterThanOrEqual  $condition
