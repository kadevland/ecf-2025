...
/**
 * @implements ApplicatorInterface<Model, ConditionGreaterThan>
 */
final class GreaterThanApplicator implements ApplicatorInterface
{
     ...
     * @param  ConditionGreaterThan  $condition
