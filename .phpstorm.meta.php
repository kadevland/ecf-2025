...
'concurrency.default','blade-icons.sets','blade-icons.class','blade-icons.attributes','blade-icons.fallback',
...
'ad','components.admin.auth.menu','components.admin.breadcrumbs','components.admin.flash-messages','components.admin.footer',
'components.admin.layout','components.admin.navbar','components.admin.page-header','components.admin.sidebar','components.app.auth.menu',
'components.app.auth.menu-mobile','components.app.breadcrumbs','components.app.flash-messages','components.app.footer','components.app.hero-header',
'components.app.layout','components.app.navbar','components.icons.cinema-logo','components.icons.home-site','components.tt',
